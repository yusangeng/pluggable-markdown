...
export default function myMarked(src, opt, tokensHandler, resultHandler, pluginRenderHandler) {
  ...
  let originalTok;
  if (pluginRenderHandler) {
    originalTok = marked.Parser.prototype.tok;
    marked.Parser.prototype.tok = function () {
      return tok.call(this, pluginRenderHandler);
    };
  }
  ...
  try {
    ...
    if (originalTok) {
      marked.Parser.prototype.tok = originalTok;
    }
  }
}
